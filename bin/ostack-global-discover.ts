 ...
 *
 * Usage:
 *   ostack-global-discover --since 7d [--format json|summary]
 *   ostack-global-discover --help
 */
...
function printUsage(): void {
  console.error(`Usage: ostack-global-discover --since <window> [--format json|summary]
...
Examples:
  ostack-global-discover --since 7d
  ostack-global-discover --since 14d --format summary`);
}
